...
cd system
echo (X)
echo Deleting Compiled ClientBTimesV5
echo ----------------------------------------------------
del ClientBTimesV5.u
del ClientBTimesV5.ucl
echo ----------------------------------------------------
echo (X)
...
cd..
cd system
ucc.exe MakeCommandletUtils.EditPackagesCommandlet 1 ClientBTimesV5
...
UCC.exe editor.stripsourcecommandlet ClientBTimesV5.u
