...
defaultproperties
{
	...
	begin object name=oPerksStyle class=STY2TabButton
		KeyName="PerkStyle"
		ImgColors(0)=(R=255,G=120,B=0,A=255)
		ImgColors(1)=(R=255,G=120,B=0,A=255)
		ImgColors(2)=(R=255,G=120,B=0,A=255)
		ImgColors(3)=(R=255,G=120,B=0,A=255)
	end object
	...
	BTTabs(2)=(Caption="Perks",TabClass=class'BTGUI_Perks',Hint="View available BestTimes perks!",Style=oPerksStyle)
	BTTabs(3)=(Caption="Achievements",TabClass=class'BTGUI_Achievements',Hint="View your BestTimes achievements!",Style=oAchievementsStyle)
