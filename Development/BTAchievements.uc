...
defaultproperties
{
	...
	Achievements(4)=(Title="Recwhore level 5",ID=recwhore_4,Type=RecordsCount,Count=100,Description="Achieve a hundred records",Points=5)
	...
	Achievements(5)=(Title="TechChallenge whore",ID=map_1,Count=50,Type=FinishTech,Description="Complete any TechChallenge map 50 times",Points=3)	// Done
 	...
 	Achievements(17)=(Title="Buy an item",ID=store_0,Description="Buy your first item from the Store",Points=1)
 	...
 	Achievements(34)=(Title="Quality enjoyment",ID=quality_0,Type=FinishQuality,Count=10,Description="Finish 10 times a map that's designed by Eliot or Haydon",Points=1)
	...
	Achievements(39)=(Title="Shopping like a girl",ID=store_2,Description="Buy 10 items",Points=2)
